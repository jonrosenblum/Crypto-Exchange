        ...
        return (
            <li className="coin-item" key={symbol}>
                ...
                <img
                    ...
                    alt={symbol}
                />
                <p className="coin-price">{`Real-Time Price: $${parsedPrice.toFixed(2)}`}</p>
            </li>
        );
    };
    ...
    return (
        <div className='coin-menu'>
            ...
            <div className="pagination-buttons">
                ...
                <button onClick={handleNextPage} disabled={currentPage === Math.ceil(cryptoArray.length / coinsPerPage) - 1}>
                    Next
                </button>
            </div>
        </div>
